...
const inputNormal = 'border-gray-300 focus:border-brand-amber focus:ring-brand-amber'
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="text-brand-amber font-semibold underline hover:text-brand-amber-dark transition-colors"
        >
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={isDisabled}
        className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-brand-amber px-6 py-3 text-sm font-semibold text-white transition-colors duration-200 hover:bg-brand-amber-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-amber focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isDisabled && <Spinner />}
